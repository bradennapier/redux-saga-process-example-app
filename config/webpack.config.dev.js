...
const componentResolver = require('component-webpack-resolver-plugin').factory;
...
module.exports = {
  ...
  resolve: {
    ...
    modules: [
      'node_modules',
      /* DASH-OS MODIFICATION */
      // Allows resolving a 'shared' directory as-if it were a module.
      // bubbles upwards.
      'shared',
      path.resolve(__dirname, 'src/app/shared'),
      /* END DASH-OS MODIFICATION */
  ...
  plugins: [
    ...
    /* DASH-OS MODIFICATION */
    // Reduce LoDash builds by automatically cherry picking
    // the appropriate modules from the package.
